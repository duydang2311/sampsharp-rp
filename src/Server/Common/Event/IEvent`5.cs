...
{
	void AddHandler(Action<T1, T2, T3, T4, T5> handler);
	void AddHandler(Func<T1, T2, T3, T4, T5, Task> handler);
	void RemoveHandler(Action<T1, T2, T3, T4, T5> handler);
	void RemoveHandler(Func<T1, T2, T3, T4, T5, Task> handler);
